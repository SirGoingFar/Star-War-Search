package com.trivago.starwarsearch.common.core.interactor
...
abstract class UseCase<out Type, in Params> where Type : Any? {
    ...
    operator fun invoke(
        params: Params, onResult: (Either<Failure, Type>) -> Unit = {},
        coroutineContext: CoroutineContext = Dispatchers.IO
    ) {

        val deferred = GlobalScope.async(coroutineContext) { execute(params) }
